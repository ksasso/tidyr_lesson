...
- Essential arguments
  ...
  + `values_to` a string specifiying the name of the new column to create from the data stored in the cell values of the columns specified in the `cols` argument, i.e. `Score`

LEFT OFF HERE AT 10 MINS IN!!!
